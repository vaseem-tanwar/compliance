                                    ...
                                    <tbody>\
                                        <tr>\
                                            <td valign="middle" align="center" style="padding:20px 0;">\
                                                <div><img src="{{ logo }}" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;"></div>\
                                            </td>\
                                        </tr>\
                                    </tbody>\
                                </table>\
                                ...
                                <table style="padding:0 15px;width:580px;"  cellspacing="0" cellpadding="0" border="0">\
                                    <tbody>\
                                        <tr>\
                                            ...
                                            <p>Hello {{ userName }},</p>\
                                            <p>Welcome to Kaizen. You can login your account with this credential.</p>\
                                            <p>Login Link: <a href="{{ weblink }}">{{ weblink }}</a></p>\
                ...
                <table style="max-width:580px;width:100%;background: {{ footer_color }};width:100%;" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">\
                    <tbody>\
                        ...
                        <tr>\
                            ...
                            Copyright © {{ year }} Corporate {{ site_name }}. All rights reserved.\
                            </td>\
                        </tr>\
                        <tr>\
                            <td width="100%" height="5"></td>\
